...
module "github_stage_secrets_payments_sls_rest_api" {
  source  = "scaffoldly/stage-secrets/github"
  version = "1.0.0"

  for_each = module.aws_serverless_api_payments_sls_rest_api.stage_config
  ...
  secrets = {
    ...
    AWS_ACCESS_KEY_ID             = module.aws_serverless_api_payments_sls_rest_api.deployer_credentials.access_key
    AWS_SECRET_ACCESS_KEY         = module.aws_serverless_api_payments_sls_rest_api.deployer_credentials.secret_key
